...
def test_normal_search_no_500(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def _fake_normal(query: str, country: str, sector: str, limit: int, language: str = "en") -> dict:
...
def test_premium_user_no_500_and_empty_result_contract(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    def _fake_premium(_query: str, _country: str, _sector: str, _limit: int, _language: str = "en") -> dict:
        return {
            "mode": "premium",
            "count": 0,
            "results": [],
