...
async def test_stress_normal_10_concurrent_same_query(monkeypatch: pytest.MonkeyPatch) -> None:
    def _fake_normal(query: str, country: str, _sector: str, limit: int, _language: str = "en") -> dict:
        return {
            "mode": "normal",
            "count": 1,
...
async def test_stress_premium_premium_20_valid_json(monkeypatch: pytest.MonkeyPatch) -> None:
    def _fake_premium(query: str, country: str, _sector: str, limit: int, _language: str = "en") -> dict:
        return {
            "mode": "premium",
            "count": 1,
...
async def test_stress_no_results_returns_empty(monkeypatch: pytest.MonkeyPatch) -> None:
    def _fake_normal(_query: str, _country: str, _sector: str, _limit: int, _language: str = "en") -> dict:
        return {
            "mode": "normal",
            "count": 0,
            "results": [],
...
async def test_stress_sources_unreachable_no_crash(monkeypatch: pytest.MonkeyPatch) -> None:
    def _failing_premium(_query: str, _country: str, _sector: str, _limit: int, _language: str = "en") -> dict:
